...
const TEST_DURATION = MAX_QUESTIONS * SECONDS_PER_QUESTION;
...
const updateTimerDisplay = () => {
    ...
    timerDisplay.classList.toggle("danger", timeLeft <= 300);
};
...
const getResultMessage = () => {
    if (score === MAX_QUESTIONS) return "Very good";
    if (score >= 55) return "Good";
    if (score >= 20) return "Do hard work";
...
const displayQuizResult = () => {
    ...
    resultMessage.innerHTML = getResultMessage();
